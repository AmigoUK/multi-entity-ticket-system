										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													<?php 
													// Hook for AI analysis fields (only in edit mode)
													if ( $is_edit ) {
														do_action( 'mets_ticket_edit_form_after_description', $ticket );
													}
													?>
												</td>
											</tr>
					...
					<div id="postbox-container-1" class="postbox-container">
						<div class="postbox">
							...
							<div class="inside">
								...
								<div style="margin-top: 15px; padding-top: 15px; border-top: 1px solid #ddd;">
									<?php submit_button( 
										$is_edit ? __( 'Update Ticket Details', METS_TEXT_DOMAIN ) : __( 'Create Ticket', METS_TEXT_DOMAIN ), 
										'primary', 
										'submit_ticket', 
										false, 
										array( 
									...
									<a href="<?php echo esc_url( admin_url( 'admin.php?page=mets-all-tickets' ) ); ?>" 
			...
			<div class="inside">
				...
				<div id="add-reply-form">
					...
					<form method="post" action="<?php echo esc_url( admin_url( 'admin.php' ) ); ?>" id="reply-form" enctype="multipart/form-data">
						...
						<input type="hidden" name="ticket_id" id="ticket_id" value="<?php echo esc_attr( $ticket->id ); ?>">
						...
						<?php 
						// Hook for AI suggest response button
						do_action( 'mets_ticket_reply_form_before_submit' );
						?>
