...
class METS_Role_Manager {
	...
	private function __construct() {
		// Delay role definition until after init to prevent early translation loading
		add_action( 'init', array( $this, 'delayed_init' ), 5 );
	}
	
	/**
	 * Initialize after init action to ensure translations are loaded
	 *
	 * @since    1.0.0
	 */
